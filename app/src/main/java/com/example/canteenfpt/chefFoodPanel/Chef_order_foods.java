...
public class Chef_order_foods extends AppCompatActivity {

    RecyclerView recyclerViewdish;
    private List<ChefPendingOrders> chefPendingOrdersList;
    private ChefOrderFoodsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chef_order_foods);
    ...
    private void Cheforderdishes() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ChefOrderFoodsAdapter(Chef_order_foods.this, chefPendingOrdersList);
